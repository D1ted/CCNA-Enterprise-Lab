...
To prevent network loops while maximizing bandwidth, I configured LACP EtherChannels between distribution switches. I enabled Rapid-PVST and manually tuned its priority so that DSW1 is the Root Bridge for VLANs 10,20 and 30 and DSW2 is the Root for VLANs 40 and 50, ensuring all links are utilized.
